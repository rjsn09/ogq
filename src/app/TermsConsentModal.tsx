      ...
      >
        ...
        >
          ...
          <p style={{ margin: "0 0 8px 0" }}>
            ...
            1. "서비스"란 이용자가 입력한 프롬프트 및 이미지를 바탕으로 네이버 OGQ 마켓 규격(24종 세트 등)에 최적화된 이모티콘 이미지를 생성하는 소프트웨어를 말합니다.<br />
          ...
          <p style={{ margin: "0 0 8px 0" }}>
            ...
            3. 특정 개인을 식별할 수 있는 고유식별정보, 주민등록번호, 타인의 개인정보를 입력하는 행위
          </p>
          <p style={{ margin: "0 0 8px 0" }}>
            ...
            3. 타인의 권리를 침해하여 발생하는 일체의 분쟁에 대한 법적 책임은 이용자 본인에게 있습니다.
          </p>
